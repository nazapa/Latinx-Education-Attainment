...
## SUMMARY OF FINDINGS
In every county that is heavily populated by Latinx folks, the percent of students with a bachelor's degree or higher has increased over the last 10 years. Across all the counties analyzed, the percent of Latina educational levels (bachelor's degree or higher) are greater than it is for Latinos. In terms of Nativity/Legal status over time in the United States, Latinos in FL and NY have higher educational attainment, but they are more likely to be citizens or descended from citizens (e.g., Cubans in FL, Puerto Ricans in NY, etc.). In contrast, TX and CA tend to have more non-citizen Latinos and first-generation students (e.g., Mexicans, Central Americans, etc.).

## BACKGROUND: LATINX STUDENT EDUCATIONAL OUTCOMES
Latino students are expected to increase by 25% by 2030 [@ExcelenciainEducation]. Now more than ever, it is important to create policies and programs that increase higher education completion rates of Latino students to put them on the pathway for shared economic prosperity [@ExcelenciainEducation].  A college graduate with a bachelor’s degree is 24% more likely to be employed and earn about $32,000 annually and $1 million higher over a lifetime [@AssociationofPublicandLand-GrantUniversities]. In 2019, the average median income for recent college graduates with a bachelor’s degree was about $44,000 per year, in comparison to high school graduates who had an average median income earning of about $33,000 per year [@AssociationofPublicandLand-GrantUniversities]. Those who obtain a bachelor’s degree are more than twice as likely to volunteer, contribute about 3.5 times more money to charity, and 75% vote in presidential elections. College graduates are also less likely to rely on government assistance programs such as medicaid, housing subsidies, nutrition assistance, unemployment benefits, etc [@AssociationofPublicandLand-GrantUniversities]. Furthermore, college graduates are 3.5 times less likely to be impoverished and about 5 times less likely to be in prison. It is evident that there are many benefits for students to pursue a higher education degree, which means that these opportunities can be even greater for Latino students.
...
```{r temp-edu-enr17, fig.cap= "ACS 1-Year Level Data: Latinx Enrollment Rates in Nursery, K-12, College/Universities, and Graduate or Professional School in California, Texas, Florida, and New York States (2012-2020)"}
...
temp_edu_enr10 %>% filter(NAME %in% c("California", "Texas", "Florida", "New York")) %>%
  ...
  scale_y_continuous(labels = label_percent(accuracy = 1))
```
In Figure \@ref(fig:temp-edu-enr25), we can see the Latinx enrollment rates in nursery school, K-12, college/universities, and graduate or professional school in California, Texas, Florida, and New York.
...
temp_edu_enr11 %>% filter(NAME == "Los Angeles-Long Beach-Anaheim, CA Metro Area") %>%
  ...
  scale_y_continuous(labels = label_percent(accuracy = 1))
```
In Figure \@ref(fig:temp-edu-enr26), we can see the Latinx enrollment rates in nursery school, K-12, college/universities, and graduate or professional school in the Los Angeles-Long Beach-Anaheim, CA Metro Area.
...
temp_edu_enr11 %>% filter(NAME == "New York-Newark-Jersey City, NY-NJ-PA Metro Area") %>%
  ...
  scale_y_continuous(labels = label_percent(accuracy = 1))
```
In Figure \@ref(fig:temp-edu-enr27), we can see the Latinx enrollment rates in nursery school, K-12, college/universities, and graduate or professional school in the New York-Newark-Jersey City, NY-NJ-PA Metro Area.
...
temp_edu_enr11 %>% filter(NAME == "Miami-Fort Lauderdale-West Palm Beach, FL Metro Area") %>%
  ...
  scale_y_continuous(labels = label_percent(accuracy = 1))
```
In Figure \@ref(fig:temp-edu-enr28), we can see the Latinx enrollment rates in nursery school, K-12, college/universities, and graduate or professional school in the Miami-Fort Lauderdale-West Palm Beach, FL Metro Area.
...
temp_edu_enr11 %>% filter(NAME == "Washington-Arlington-Alexandria, DC-VA-MD-WV Metro Area") %>%
  ...
  scale_y_continuous(labels = label_percent(accuracy = 1))
```
In Figure \@ref(fig:temp-edu-enr29), we can see the Latinx enrollment rates in nursery school, K-12, college/universities, and graduate or professional school in the Washington-Arlington-Alexandria, DC-VA-MD-WV Metro Area.
...
temp_edu_enr11 %>% filter(NAME == "Providence-Warwick, RI-MA Metro Area") %>%
  ...
  scale_y_continuous(labels = label_percent(accuracy = 1))
```
In Figure \@ref(fig:temp-edu-enr30), we can see the Latinx enrollment rates in nursery school, K-12, college/universities, and graduate or professional school in the Providence-Warwick, RI-MA Metro Area.
...
temp_edu_enr12 %>% filter(NAME %in% c("Los Angeles County, California", "Cook County, Illinois","Maricopa County, Arizona", "Orange County, California", "Bexar County, Texas", "Riverside County, California", "San Bernardino County, California", "San Diego County, California")) %>%
  ...
  scale_y_continuous(labels = label_percent(accuracy = 1))
```
In Figure \@ref(fig:temp-edu-enr31), we can see the Latinx enrollment rates in nursery school, K-12, college/universities, and graduate or professional school in the Los Angeles County, CA, Cook County, IL, Maricopa County, AZ, Orange County, CA, Bexar County, TX, Riverside County, CA, San Bernardino County, CA, and San Diego County, CA.
...
temp_edu_enr12 %>% filter(NAME == "Los Angeles County, California") %>%
  ...
  scale_y_continuous(labels = label_percent(accuracy = 1))
```
In Figure \@ref(fig:temp-edu-enr32), we can see the Latinx enrollment rates in nursery school, K-12, college/universities, and graduate or professional school in the Los Angeles County, CA.
